 ...
 **hello-rails-back-end** is app build using ruby on rails and react ([react-repo](https://github.com/QueenterJuma/hello-react-front-end))
...
```sh
  cd my-folder
  https://github.com/QueenterJuma/hello-rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/QueenterJuma/hello-rails-back-end/issues).
